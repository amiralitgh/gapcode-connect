APP        := gapcode-connect
MODULE     := github.com/amiralitgh/gapcode-connect
CMD        := ./cmd/cc-connect
DIST       := dist
...
ALL_PLATFORMS := feishu telegram bale discord slack dingtalk wecom weixin qq qqbot line weibo max matrix webex cloud_web tuitui googlechat
ALL_EXTRAS    := web
