...
const PRESETS: CronPreset[] = [
  { label: 'Every minute', labelFa: 'هر دقیقه', expr: '* * * * *' },
  { label: 'Every 5 min', labelFa: 'هر ۵ دقیقه', expr: '*/5 * * * *' },
  { label: 'Every 15 min', labelFa: 'هر ۱۵ دقیقه', expr: '*/15 * * * *' },
  { label: 'Every 30 min', labelFa: 'هر ۳۰ دقیقه', expr: '*/30 * * * *' },
  { label: 'Every hour', labelFa: 'هر ساعت', expr: '0 * * * *' },
  { label: 'Every 2 hours', labelFa: 'هر ۲ ساعت', expr: '0 */2 * * *' },
  { label: 'Every 6 hours', labelFa: 'هر ۶ ساعت', expr: '0 */6 * * *' },
  { label: 'Daily 6:00', labelFa: 'روزانه ۶:۰۰', expr: '0 6 * * *' },
  { label: 'Daily 9:00', labelFa: 'روزانه ۹:۰۰', expr: '0 9 * * *' },
  { label: 'Daily 12:00', labelFa: 'روزانه ۱۲:۰۰', expr: '0 12 * * *' },
  { label: 'Daily 18:00', labelFa: 'روزانه ۱۸:۰۰', expr: '0 18 * * *' },
  { label: 'Daily 22:00', labelFa: 'روزانه ۲۲:۰۰', expr: '0 22 * * *' },
  { label: 'Weekdays 9:00', labelFa: 'روزهای کاری ۹:۰۰', expr: '0 9 * * 1-5' },
  { label: 'Weekly Mon 9AM', labelFa: 'دوشنبه‌ها ۹:۰۰', expr: '0 9 * * 1' },
  { label: 'Monthly 1st', labelFa: 'روز اول ماه', expr: '0 0 1 * *' },
];
  ...
  return (
    <div className="space-y-2">
      <div className="relative">
        ...
        >
          <option value="" disabled>{isFarsi ? 'انتخاب زمان‌بندی' : 'Select schedule'}</option>
          {PRESETS.map(p => (
            <option key={p.expr} value={p.expr}>
              {isFarsi ? p.labelFa : p.label} ({p.expr})
            </option>
          ))}
          <option value={CUSTOM_VALUE}>{isFarsi ? '✏ عبارت سفارشی' : '✏ Custom expression'}</option>
        </select>
