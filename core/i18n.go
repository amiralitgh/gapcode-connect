...
// accepted spellings are English, Farsi, and "" / "auto" for auto-detect.
...
func isFarsi(r rune) bool {
	switch r {
	case 'پ', 'چ', 'ژ', 'گ', 'ک', 'ی', 'ے':
		return true
	default:
		// Arabic and Persian share most code points. Arabic is not a
		// separately supported locale, so treat Arabic-script input as Farsi
		// unless a future locale adds a more specific classifier.
...
const (
	...
	MsgBuiltinCmdCD            MsgKey = "cd"
	MsgBuiltinCmdPwd           MsgKey = "pwd"
	MsgBuiltinCmdLS            MsgKey = "ls"
	MsgBuiltinCmdMkdir         MsgKey = "mkdir"
	MsgBuiltinCmdLaunchGapCode MsgKey = "launch_gapcode"
	...
	MsgMkdirUsage          MsgKey = "mkdir_usage"
	MsgGapCodeReady        MsgKey = "gapcode_ready"
	MsgShow                MsgKey = "show"
	...
	// to the agent's own system prompt by core/interfaces.go
	// AgentSystemPromptForLang.
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgLangInvalid: {
		LangEnglish:            "Unknown language. Supported: `en`, `fa`, `auto`.",
	...
	MsgLangCurrent: {
		LangEnglish:            "🌐 Current language: **%s**\n\nUsage: /lang <en|fa|auto>",
		LangChinese:            "🌐 当前语言: **%s**\n\n用法: /lang <en|zh|zh-TW|ja|es|fa|auto>",
		LangTraditionalChinese: "🌐 當前語言: **%s**\n\n用法: /lang <en|zh|zh-TW|ja|es|fa|auto>",
		LangJapanese:           "🌐 現在の言語: **%s**\n\n使い方: /lang <en|zh|zh-TW|ja|es|fa|auto>",
		LangSpanish:            "🌐 Idioma actual: **%s**\n\nUso: /lang <en|zh|zh-TW|ja|es|fa|auto>",
	},
	MsgUnknownCommand: {
		LangEnglish:            "`%s` is not a GapCode Connect command, forwarding to agent...",
		LangChinese:            "`%s` 不是 GapCode Connect 命令，已转发给 Agent 处理...",
		LangTraditionalChinese: "`%s` 不是 GapCode Connect 命令，已轉發給 Agent 處理...",
		LangJapanese:           "`%s` は GapCode Connect のコマンドではありません。エージェントに転送します...",
		LangSpanish:            "`%s` no es un comando de GapCode Connect, reenviando al agente...",
	},
	MsgWelcome: {
		LangEnglish:            "👋 Hi! I'm GapCode Connect, bridging you to **%s**.\n\nJust send a message to chat with the agent. Type /help to see built-in commands.",
		LangChinese:            "👋 你好！我是 GapCode Connect，已为你连接到 **%s**。\n\n直接发送消息即可与 Agent 对话。输入 /help 查看内置命令。",
		LangTraditionalChinese: "👋 你好！我是 GapCode Connect，已為你連接到 **%s**。\n\n直接發送訊息即可與 Agent 對話。輸入 /help 查看內建命令。",
		LangJapanese:           "👋 こんにちは！GapCode Connect が **%s** に接続しました。\n\nメッセージを送信すればエージェントと会話できます。/help で組み込み命令一覧を確認できます。",
		LangSpanish:            "👋 ¡Hola! Soy GapCode Connect, conectándote con **%s**.\n\nEnvía un mensaje para chatear con el agente. Usa /help para ver los comandos integrados.",
	},
	MsgHelp: {
		LangEnglish: "📖 Available Commands\n\n" +
			"/new [name]\n  Start a new session\n\n" +
			"/list [all]\n  List agent sessions in the current directory, or all directories\n\n" +
			...
			"/dir [path|reset]\n  Show, switch, or reset agent working directory (alias: /cd)\n\n" +
			...
			"/restart\n  Restart GapCode Connect service\n\n" +
			"/status\n  Show system status\n\n" +
			"/version\n  Show GapCode Connect version\n\n" +
		...
		LangChinese: "📖 可用命令\n\n" +
			...
			"/reasoning [级别]\n  查看/切换推理强度\n\n" +
			"/mode [名称]\n  查看/切换权限模式\n\n" +
			"/lang [en|zh|zh-TW|ja|es|fa|auto]\n  查看/切换语言\n\n" +
			"/compress\n  压缩会话上下文\n\n" +
			"/tts [always|voice_only]\n  查看/切换语音合成模式\n\n" +
			...
			"/usage\n  查看账号/模型限额使用情况\n\n" +
			"/upgrade\n  检查更新并自动升级\n\n" +
			"/restart\n  重启 GapCode Connect 服务\n\n" +
			"/status\n  查看系统状态\n\n" +
			"/version\n  查看 GapCode Connect 版本\n\n" +
		...
		LangJapanese: "📖 利用可能なコマンド\n\n" +
			...
			"/usage\n  アカウント/モデル使用量を表示\n\n" +
			"/upgrade\n  アップデートを確認して自動更新\n\n" +
			"/restart\n  GapCode Connect サービスを再起動\n\n" +
			"/status\n  システム状態を表示\n\n" +
			"/version\n  GapCode Connect のバージョンを表示\n\n" +
		...
		LangSpanish: "📖 Comandos disponibles\n\n" +
			...
			"/restart\n  Reiniciar el servicio GapCode Connect\n\n" +
			"/status\n  Mostrar estado del sistema\n\n" +
			"/version\n  Mostrar versión de GapCode Connect\n\n" +
	...
	MsgHelpTitle: {
		LangEnglish:            "GapCode Connect Help",
		LangChinese:            "GapCode Connect 帮助",
		LangTraditionalChinese: "GapCode Connect 說明",
		LangJapanese:           "GapCode Connect ヘルプ",
		LangSpanish:            "GapCode Connect Ayuda",
	},
	...
	MsgHelpAgentSection: {
		LangEnglish: "**Agent Configuration**\n" +
			...
			"/lang [en|fa|auto] — View/switch language",
		...
		LangSpanish: "**Configuración del agente**\n" +
			...
			"/lang [en|zh|...|fa] — Ver/cambiar idioma",
	},
	MsgHelpToolsSection: {
	...
	MsgStatusTitle: {
		LangEnglish: "GapCode Connect Status\n\n" +
			"Project: %s\n" +
			"Agent: %s\n" +
			"Work Dir: %s\n" +
			"Platforms: %s\n" +
			...
			"Language: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangChinese: "GapCode Connect 状态\n\n" +
			"项目: %s\n" +
			"Agent: %s\n" +
			"工作目录: %s\n" +
			"平台: %s\n" +
			...
			"语言: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangTraditionalChinese: "GapCode Connect 狀態\n\n" +
			"項目: %s\n" +
			"Agent: %s\n" +
			"工作目錄: %s\n" +
			"平台: %s\n" +
			...
			"語言: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangJapanese: "GapCode Connect ステータス\n\n" +
			"プロジェクト: %s\n" +
			"エージェント: %s\n" +
			"作業ディレクトリ: %s\n" +
			"プラットフォーム: %s\n" +
			...
			"言語: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangSpanish: "Estado de GapCode Connect\n\n" +
			"Proyecto: %s\n" +
			"Agente: %s\n" +
			"Directorio: %s\n" +
			"Plataformas: %s\n" +
	...
	MsgCardTitleStatus: {
		LangEnglish: "GapCode Connect Status", LangChinese: "GapCode Connect 状态", LangTraditionalChinese: "GapCode Connect 狀態",
		LangJapanese: "GapCode Connect ステータス", LangSpanish: "Estado de GapCode Connect",
	},
	...
	MsgRestarting: {
		LangEnglish:            "🔄 Restarting GapCode Connect...",
		LangChinese:            "🔄 正在重启 GapCode Connect...",
		LangTraditionalChinese: "🔄 正在重啟 GapCode Connect...",
		LangJapanese:           "🔄 GapCode Connect を再起動中...",
		LangSpanish:            "🔄 Reiniciando GapCode Connect...",
	},
	MsgRestartSuccess: {
		LangEnglish:            "✅ GapCode Connect restarted successfully.",
		LangChinese:            "✅ GapCode Connect 重启成功。",
		LangTraditionalChinese: "✅ GapCode Connect 重啟成功。",
		LangJapanese:           "✅ GapCode Connect の再起動が完了しました。",
		LangSpanish:            "✅ GapCode Connect se reinició correctamente.",
	},
	MsgUpgradeChecking: {
	...
	MsgRelaySetupHint: {
		LangEnglish:            "\n\n⚠️ This agent does not auto-inject GapCode Connect instructions.\nPlease run `/bind setup` or `/cron setup` to write instructions to %s.",
		LangChinese:            "\n\n⚠️ 当前 agent 不会自动注入 GapCode Connect 指令。\n请运行 `/bind setup` 或 `/cron setup` 将指令写入 %s。",
		LangTraditionalChinese: "\n\n⚠️ 當前 agent 不會自動注入 GapCode Connect 指令。\n請執行 `/bind setup` 或 `/cron setup` 將指令寫入 %s。",
		LangJapanese:           "\n\n⚠️ このエージェントは GapCode Connect の指示を自動注入しません。\n`/bind setup` または `/cron setup` を実行して %s に指示を書き込んでください。",
		LangSpanish:            "\n\n⚠️ Este agente no inyecta automáticamente las instrucciones de GapCode Connect.\nEjecute `/bind setup` o `/cron setup` para escribirlas en %s.",
	},
	MsgRelaySetupOK: {
		LangEnglish:            "✅ GapCode Connect instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ GapCode Connect 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
		LangTraditionalChinese: "✅ GapCode Connect 指令已寫入 %s\nagent 現在可以使用中繼、定時任務和附件回傳功能了。",
		LangJapanese:           "✅ GapCode Connect の指示を %s に書き込みました。\nエージェントがリレー、cron、添付ファイル返送を使えるようになりました。",
		LangSpanish:            "✅ Instrucciones de GapCode Connect escritas en %s\nEl agente ahora puede usar relay, cron y reenvío de adjuntos.",
	},
	MsgRelaySetupExists: {
		LangEnglish:            "ℹ️ GapCode Connect instructions already exist in %s — no changes made.",
		LangChinese:            "ℹ️ GapCode Connect 指令已存在于 %s 中，无需重复写入。",
		LangTraditionalChinese: "ℹ️ GapCode Connect 指令已存在於 %s 中，無需重複寫入。",
		LangJapanese:           "ℹ️ GapCode Connect の指示は既に %s に存在します。変更はありません。",
		LangSpanish:            "ℹ️ Las instrucciones de GapCode Connect ya existen en %s — sin cambios.",
	},
	...
	MsgSetupNative: {
		LangEnglish:            "✅ This agent natively supports GapCode Connect instructions — no setup needed.",
		LangChinese:            "✅ 当前 agent 已原生支持 GapCode Connect 指令，无需额外配置。",
		LangTraditionalChinese: "✅ 當前 agent 已原生支持 GapCode Connect 指令，無需額外配置。",
		LangJapanese:           "✅ このエージェントは GapCode Connect の指示をネイティブサポートしています。セットアップ不要です。",
		LangSpanish:            "✅ Este agente soporta nativamente las instrucciones de GapCode Connect — no se necesita configuración.",
	},
	MsgCronSetupOK: {
		LangEnglish:            "✅ GapCode Connect instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ GapCode Connect 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
	...
	MsgBuiltinCmdLang: {
		LangEnglish:            "View/switch language, arg: [en|zh|zh-TW|ja|es|fa|auto]",
		LangChinese:            "查看/切换语言，参数: [en|zh|zh-TW|ja|es|fa|auto]",
		LangTraditionalChinese: "查看/切換語言，參數: [en|zh|zh-TW|ja|es|fa|auto]",
		LangJapanese:           "言語の表示/切り替え、引数: [en|zh|zh-TW|ja|es|fa|auto]",
		LangSpanish:            "Ver/cambiar idioma, arg: [en|zh|zh-TW|ja|es|fa|auto]",
	},
	MsgBuiltinCmdQuiet: {
	...
	MsgBuiltinCmdRestart: {
		LangEnglish:            "Restart GapCode Connect service",
		LangChinese:            "重启 GapCode Connect 服务",
		LangTraditionalChinese: "重啟 GapCode Connect 服務",
		LangJapanese:           "GapCode Connect サービスを再起動",
		LangSpanish:            "Reiniciar el servicio GapCode Connect",
	},
	MsgBuiltinCmdStatus: {
	...
	MsgBuiltinCmdVersion: {
		LangEnglish:            "Show GapCode Connect version",
		LangChinese:            "查看 GapCode Connect 版本",
		LangTraditionalChinese: "查看 GapCode Connect 版本",
		LangJapanese:           "GapCode Connect のバージョンを表示",
		LangSpanish:            "Mostrar versión de GapCode Connect",
	},
	MsgBuiltinCmdHelp: {
	...
	MsgBuiltinCmdCD: {
		LangEnglish: "Change the persistent working directory, arg: <path>",
		LangFarsi:   "تغییر پوشهٔ کاری پایدار، پارامتر: <مسیر>",
	},
	MsgBuiltinCmdPwd: {
		LangEnglish: "Show the persistent working directory",
		LangFarsi:   "نمایش پوشهٔ کاری پایدار",
	},
	MsgBuiltinCmdLS: {
		LangEnglish: "List files in the persistent working directory, arg: [arguments]",
		LangFarsi:   "نمایش فایل‌ها در پوشهٔ کاری پایدار، پارامتر: [آرگومان‌ها]",
	},
	MsgBuiltinCmdMkdir: {
		LangEnglish: "Create directories in the persistent working directory, arg: <arguments>",
		LangFarsi:   "ساخت پوشه در پوشهٔ کاری پایدار، پارامتر: <آرگومان‌ها>",
	},
	MsgBuiltinCmdLaunchGapCode: {
		LangEnglish: "Launch or resume GapCode in the current working directory",
		LangFarsi:   "راه‌اندازی یا ادامهٔ GapCode در پوشهٔ کاری فعلی",
	},
	MsgDiffEmpty: {
	...
	MsgMkdirUsage: {
		LangEnglish: "Usage: `/mkdir <directory>`",
		LangFarsi:   "استفاده: `/mkdir <پوشه>`",
	},
	MsgGapCodeReady: {
		LangEnglish: "✅ GapCode session ready in `%s`.",
		LangFarsi:   "✅ نشست GapCode در `%s` آماده است.",
	},
	MsgShow: {
...
func init() {
	farsi := map[MsgKey]string{
		MsgStarting:              "⏳ در حال پردازش...",
		MsgThinking:              "💭 %s",
		MsgTool:                  "🔧 **ابزار شماره %d: %s**\n---\n%s",
		MsgToolResult:            "📤 **%s**\n---\n%s",
		MsgToolResultFmtStatus:   "وضعیت",
		MsgToolResultFmtExit:     "کد خروج",
		MsgToolResultFmtNoOutput: "بدون خروجی",
		MsgToolResultFmtOk:       "موفق",
		MsgToolResultFmtFailed:   "ناموفق",
		MsgExecutionStopped:      "⏹ اجرا متوقف شد.",
		MsgSessionCancelled:      "جلسه لغو شد. آماده دریافت دستورهای جدید هستم.",
		MsgNoExecution:           "هیچ اجرایی در حال انجام نیست.",
		MsgPreviousProcessing:    "⏳ درخواست قبلی هنوز در حال پردازش است.",
		MsgMessageQueued:         "📬 پیام دریافت شد و پس از پایان کار فعلی پردازش می‌شود.",
		MsgQueueFull:             "📬 صف پیام‌ها پر است. لطفاً صبر کنید.",
		MsgError:                 "❌ خطا: %v",
		MsgEmptyResponse:         "(پاسخ خالی)",
		MsgPermissionPrompt:      "⚠️ **درخواست مجوز**\n\nعامل می‌خواهد از **%s** استفاده کند:\n\n```\n%s\n```\n\n`allow` / `deny` / `allow all` را ارسال کنید.",
		MsgPermissionAllowed:     "✅ مجوز صادر شد، ادامه می‌دهم...",
		MsgPermissionDenied:      "❌ رد شد. عامل استفاده از این ابزار را متوقف می‌کند.",
		MsgModeChanged:           "🔄 حالت مجوز به **%s** تغییر کرد.",
		MsgSessionRestarting:     "🔄 فرایند جلسه پایان یافت؛ در حال راه‌اندازی مجدد...",
		MsgSessionNotStarted:     "(جدید — هنوز شروع نشده)",
		MsgLangChanged:           "🌐 زبان به **%s** تغییر کرد.",
		MsgLangInvalid:           "زبان ناشناخته است. زبان‌های پشتیبانی‌شده: `en`, `fa`, `auto`.",
		MsgLangCurrent:           "🌐 زبان فعلی: **%s**\n\nاستفاده: `/lang <en|fa|auto>`",
		MsgUnknownCommand:        "`%s` دستور شناخته‌شده‌ای نیست؛ برای عامل ارسال می‌شود...",
		MsgWelcome:               "👋 سلام! من GapCode Connect هستم و شما را به **%s** متصل می‌کنم.\n\nبرای گفتگو با عامل یک پیام بفرستید. برای دیدن دستورها از `/help` استفاده کنید.",
		MsgHelpTitle:             "راهنمای GapCode Connect",
		MsgHelp: "📖 دستورهای موجود\n\nبرای شروع، یک پیام معمولی بفرستید تا به GapCode ارسال شود.\n\n" +
			"/new [name]\n  شروع نشست جدید\n\n" +
			"/list [all]\n  نمایش نشست‌های پوشه فعلی یا همه پوشه‌ها\n\n" +
			"/switch [all] <number>\n  تغییر نشست فعال\n\n" +
			"/current\n  نمایش نشست فعلی\n\n" +
			"/history [n]\n  نمایش پیام‌های اخیر\n\n" +
			"/name [number] <text>\n  نام‌گذاری نشست (نام مستعار: /rename)\n\n" +
			"/model [switch <name>]\n  نمایش یا تغییر مدل\n\n" +
			"/reasoning [level]\n  نمایش یا تغییر سطح استدلال\n\n" +
			"/mode [name]\n  نمایش یا تغییر حالت دسترسی\n\n" +
			"/lang [en|fa|auto]\n  تغییر زبان\n\n" +
			"/stop\n  توقف اجرای فعلی\n\n" +
			"/dir [path|reset]\n  نمایش یا تغییر پوشه کاری (نام مستعار: /cd)\n\n" +
			"/status\n  نمایش وضعیت\n\n" +
			"/version\n  نمایش نسخه\n\n" +
			"/whoami\n  نمایش شناسه کاربری\n\n" +
			"/help\n  نمایش همین راهنما",
		MsgCardTitleLanguage:       "انتخاب زبان",
		MsgCardTitleStatus:         "وضعیت GapCode Connect",
		MsgCardTitleCurrentSession: "جلسه فعلی",
		MsgCardTitleHistory:        "تاریخچه",
		MsgCardTitleCommands:       "دستورها",
		MsgBuiltinCmdNew:           "شروع نشست جدید",
		MsgBuiltinCmdList:          "نمایش نشست‌های عامل",
		MsgBuiltinCmdSearch:        "جست‌وجوی نشست‌ها",
		MsgBuiltinCmdSwitch:        "تغییر نشست فعال",
		MsgBuiltinCmdDelete:        "حذف نشست",
		MsgBuiltinCmdName:          "نام‌گذاری نشست",
		MsgBuiltinCmdCurrent:       "نمایش نشست فعلی",
		MsgBuiltinCmdHistory:       "نمایش تاریخچه پیام‌ها",
		MsgBuiltinCmdProvider:      "مدیریت ارائه‌دهنده‌های API",
		MsgBuiltinCmdMemory:        "نمایش یا ویرایش حافظه عامل",
		MsgBuiltinCmdAllow:         "اجازه ابزار برای نشست بعدی",
		MsgBuiltinCmdModel:         "نمایش یا تغییر مدل",
		MsgBuiltinCmdReasoning:     "نمایش یا تغییر سطح استدلال",
		MsgBuiltinCmdMode:          "نمایش یا تغییر حالت دسترسی",
		MsgBuiltinCmdLang:          "نمایش یا تغییر زبان؛ پارامتر: [en|fa|auto]",
		MsgBuiltinCmdQuiet:         "نمایش یا پنهان‌کردن پیشرفت ابزار",
		MsgBuiltinCmdCompress:      "فشرده‌سازی زمینه گفتگو",
		MsgBuiltinCmdStop:          "توقف اجرای فعلی",
		MsgBuiltinCmdCron:          "مدیریت کارهای زمان‌بندی‌شده",
		MsgBuiltinCmdCommands:      "مدیریت دستورهای سفارشی",
		MsgBuiltinCmdAlias:         "مدیریت نام‌های مستعار دستورها",
		MsgBuiltinCmdSkills:        "نمایش مهارت‌های عامل",
		MsgBuiltinCmdConfig:        "نمایش یا تغییر پیکربندی",
		MsgBuiltinCmdDoctor:        "اجرای عیب‌یابی سیستم",
		MsgBuiltinCmdUpgrade:       "بررسی و نصب به‌روزرسانی",
		MsgBuiltinCmdRestart:       "راه‌اندازی مجدد سرویس",
		MsgBuiltinCmdStatus:        "نمایش وضعیت سیستم",
		MsgBuiltinCmdUsage:         "نمایش میزان مصرف حساب",
		MsgBuiltinCmdVersion:       "نمایش نسخه",
		MsgBuiltinCmdHelp:          "نمایش راهنما",
		MsgBuiltinCmdBind:          "مدیریت اتصال رله",
		MsgBuiltinCmdShell:         "اجرای دستور شل",
		MsgBuiltinCmdDir:           "نمایش یا تغییر پوشه کاری",
		MsgBuiltinCmdDiff:          "نمایش تغییرات پروژه",
		MsgBuiltinCmdPs:            "نمایش فرایندهای عامل",
	}
	for key, value := range farsi {
		if messages[key] != nil {
			messages[key][LangFarsi] = value
		}
	}
}
...
// TIn translates a message using an explicit locale, independent of the
// current conversation language. Platform command menus use this so their
// fixed metadata remains readable while replies can still be localized.
func (i *I18n) TIn(lang Language, key MsgKey) string {
	if lang == LangAuto {
		lang = LangEnglish
	}
	return translateMessage(lang, key)
...
func translateMessage(lang Language, key MsgKey) string {
