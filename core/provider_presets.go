...
const (
	defaultPresetsURL         = "https://raw.githubusercontent.com/amiralitgh/gapcode-connect/main/config/provider-presets.json"
	fallbackPresetsURL        = "https://gitee.com/chenhg5/cc-connect/raw/main/config/provider-presets.json"
