...
const (
	defaultSkillPresetsURL         = "https://raw.githubusercontent.com/amiralitgh/gapcode-connect/main/config/skill-presets.json"
	fallbackSkillPresetsURL        = "https://gitee.com/chenhg5/cc-connect/raw/main/config/skill-presets.json"
