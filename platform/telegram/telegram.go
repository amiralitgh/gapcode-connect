...
func New(opts map[string]any) (core.Platform, error) {
	return newPlatform(opts, "telegram", "https://api.telegram.org")
}

// NewBale creates a Telegram-compatible Bot API platform against Bale's
...
func defaultNewBot(token string, onUpdate func(context.Context, *models.Update), httpClient *http.Client) (telegramBot, *models.User, func(context.Context), error) {
	return defaultNewBotAtURL(token, onUpdate, httpClient, "https://api.telegram.org")
}

func defaultNewBotAtURL(token string, onUpdate func(context.Context, *models.Update), httpClient *http.Client, apiBaseURL string) (telegramBot, *models.User, func(context.Context), error) {
