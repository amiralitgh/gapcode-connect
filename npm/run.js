...
if (needsReinstall()) {
  console.log(`[gapcode-connect] Binary missing or outdated, installing v${EXPECTED_VER}...`);
  try {
    ...
    console.error("[gapcode-connect] Auto-install failed. Run manually: npm uninstall -g gapcode-connect && npm install -g gapcode-connect@beta");
    process.exit(1);
  }
}
